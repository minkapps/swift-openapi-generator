            ...
            public enum Schemas {
                ...
                public struct MyObject: Codable, Hashable, Sendable {
                    ...
                    public init(from decoder: any Swift.Decoder) throws {
                        ...
                        self.alias = try container.decodeIfPresent(
                            Swift.String.self,
                            forKey: .alias
                        )
                        self.requiredString = try container.decode(
                            Components.Schemas.MyRequiredString.self,
                            forKey: .requiredString
                        )
                        self.nullableString = try container.decode(
                            Components.Schemas.MyNullableString?.self,
                            forKey: .nullableString
                        )
                    }
                    public func encode(to encoder: any Swift.Encoder) throws {
                        var container = encoder.container(keyedBy: CodingKeys.self)
        ...
        try XCTAssertSwiftEquivalent(
            ...
            public enum Schemas {
                public struct ProfileLanguage: Codable, Hashable, Sendable {
                    ...
                    public init(proficiency: Components.Schemas.ProfileLanguage.proficiencyPayload?) {
